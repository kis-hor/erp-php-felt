                                            ...
                                            <div class="p-lg-5 p-4">
                                                ...
                                                <div class="mt-4">
                                                    <form action="login-process" class="auth-input" method="post">
                                                        ...
                                                        <!-- reCAPTCHA -->
                                                        <div class="g-recaptcha mb-3" data-sitekey="6Lcn9SIqAAAAALdZf6DarKm5jdNzSJq1M5N5rEiZ"></div>

                                                        <div class="mt-2">
                                                            <button class="btn btn-primary w-100" type="submit" name="admin_login">Log In</button>
                                                        </div>
